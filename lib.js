 ...
 */
function decorateNonCombiningMark(char, decorator){
...
const styles = new Map([
	...
	['boxed', funcTransform((char) => decorateNonCombiningMark(char, '\u0332\u0305'))],
	['striked', funcTransform((char) => decorateNonCombiningMark(char, '\u0336'))],
	['deleted', funcTransform((char) => decorateNonCombiningMark(char, '\u0338'))],
	['camelCase', funcTransform((char, index) => index % 2 === 0 ? char.toUpperCase() : char.toLowerCase())],
	['inverted', (text) => [...text].reverse().join('')],
	['matrix', funcTransform((char) => decorateNonCombiningMark(char, ['\u033f', '\u0347', '\u033f\u0347', '\u0305', '\u0332', '\u0305\u0332', '\u0336', '\u0347'][Math.floor(Math.random() * 7)]))],
	['doubleLetters', funcTransform((char) => decorateNonCombiningMark(char, char))],
...
export {decorateText as default};